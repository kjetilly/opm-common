 ...
 *
 * The hand-unrolled per-N specializations have been removed in favour of the
 * primary template in Evaluation.hpp.  Only the run-time sized
 * (DynamicEvaluation) specialization remains.
 */
